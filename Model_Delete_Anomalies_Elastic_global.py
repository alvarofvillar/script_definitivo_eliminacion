...
# partition:               Variable que indica si el Job de Deteccion de Anomalias tiene una partición por un campo categórico mediante la opcion Split field. Acepta el valor 1 si hay division o 0 si no hay division.
# partition_field:         Variable que indica el nombre del campo por el que se realiza la particion en el Job de deteccion de anomalías. Solo debe existir si la variable partition tiene el valor 1. 
#
# OUTPUTS: 
...
# --------------------------------------------------------------------------------------------LECTURA DE FICHERO------------------------------------------------------------------
# Fichero de datos
file_input_Json = "Input_Delete_Anomalies_Elastic_global.json"
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
